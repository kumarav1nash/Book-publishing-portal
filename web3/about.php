...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    <div>
                        ...
                        <ul class="nav navbar-nav navbar-left cl-effect-15">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="shop.html">From the web</a>
                                    </li>
                                    <li>
                                        <a href="single_product.html">Chronicle featured</a>
                                    </li>
                                  <!--  <li>
        ...
        <!-- copyright footer -->
        <div class="cpy-right">
            <p>© 2018 Chronicle. All rights reserved <span style="color:transparent;"> | Design by</span>
                <a href="http://w3layouts.com"><span style="color:transparent;"> W3layouts.</span></a>
            </p>
        </div>
    </div>
    <!-- //home -->
