...
<section id="main-content">
	<section class="wrapper">
	  <div id="Q_form_head">
	     <h2 class="panel-heading"><b>Quotes</b></h2>
		 <div id="Q_form">
		   <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="quotes_handler.php" method="post">
                                <div class="form-group">
                                    
                                    <input type="hidden" class="form-control" name="poster_id" value="<?php echo $row1["Email"]; ?>">
                                </div>
								<div class="form-group">
                                    
                                    <input type="hidden" class="form-control" name="poster_name" value="<?php echo $row1["First_Name"]." ".$row1["Last_Name"];; ?>">
                                </div>
                                <div class="form-group">
                                    
                                    <input type="hidden" class="form-control" name="date" value="<?php echo date("D")." ".date("d/m/Y");?>">
                                </div>
								<div class="form-group">
								<label class=" col-sm-3 control-label">Select Resource type</label>         
                                     <select class="form-control m-bot15" name="resource_type">
										<option value="Books">From Books</option>
										<option value="Movies">From Movies</option>
										<option value="Noble Men Words">From Noble Men</option>
								...
								<div class="form-group">         
                                    <input type="text" name="resource_name" class="form-control" value="Enter Resource Name">
                                </div>
								<div class="form-group">         
                                    <textarea rows="8" cols="50" class="form-control" name="quotes" >What's in your mind today?</textarea>
                                </div>
