...
include '../web3/dbconnect.php';
  ...
  if(isset($_SESSION["authorid"]))
  {
    ...
    $result1=mysqli_query($con,"select * from author_register where email='$eml'");
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                <li class=""><a href="../web3/author_profile.php"><i class=" fa fa-suitcase"></i>Profile</a></li>
                <li class="disabled"><a><i class="fa fa-cog"></i> Settings</a></li>
				<li><a href="../web3/index.php"><i class="fa fa-cog"></i>GoTo User Panel</a></li>
